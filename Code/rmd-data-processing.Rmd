...
The code below combines the data tables `raw`, `labeled`, and `pi_affiliation_project`. The output will be saved in a data table named `data` and also saved as a rds file named `projects.rds` which will be used later.
