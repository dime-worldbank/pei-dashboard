...
`r fa("list-alt", fill = "#9bd3cc", height = "3em", width = "3em")` <br>
[BASIC PROGRAM INFORMATION]{.coltitle} <br><br>
...
::: {class='col-sm-4 colinfo'}
`r fa("address-card", fill = "#9bd3cc", height = "3em", width = "3em")` <br>
[PARTICIPANT PROFILE]{.coltitle} <br><br>
...
::: {class='col-sm-4 colinfo'}
`r fa("users", fill = "#9bd3cc", height = "3em", width = "3em")` <br>
[PROGRAM COVERAGE]{.coltitle} <br><br>
...
`r fa("book-reader", fill = "#494c50", height = "3em", width = "3em")` <br>
[PRINCIPAL INVESTIGATORS]{.pititle} <br><br>
[`r data[, "pi_list"]`]{.pitext} <br> <br>
`r fa("calendar-alt", fill = "#494c50", height = "3em", width = "3em")` <br>
...
[- What is the cost-effectiveness of large-scale government-led programs?]{`r if (str_detect(data$learning_p,"Cost-effectiveness of large-scale government-led programs")) {".activelp"}`} <br>
[- What is the nature and extent of spillovers on the local economy and general equilibrium effects?]{`r if (str_detect(data$learning_p,"Spillovers and general equilibrium effects")) {".activelp"}`}
:::

::: {class='col-sm-3 learningdetails'}
[- How do alternative delivery modalities that enhance scalability affect program impact and cost-effectiveness?]{`r if (str_detect(data$learning_p,"Scalability, impact and cost-effectiveness")) {".activelp"}`}
:::

::: {class='col-sm-3 learningdetails'}
[- How do impacts vary over time?  Are they sustained in the short to long-term? How does it affect cost-benefit analysis?]{`r if (str_detect(data$learning_p,"How impacts vary over time")) {".activelp"}`}
:::

::: {class='col-sm-3 learningdetails'}
[- What is the marginal contribution of constituent interventions (including cash) to overall impact and overall cost? What is the minimum appropriate bundle or optimal bundle for a given context?]{`r if (str_detect(data$learning_p,"Optimal bundle/marginal contribution of bundled interventions")) {".activelp"}`} <br>
[- Does the timing, sequencing, and intensity of interventions matter?]{`r if (str_detect(data$learning_p,"Timing, sequencing, and intensity of bundled interventions")) {".activelp"}`}
:::
...
::: {class='col-sm-3 learningdetails'}
[- What is the cost-effectiveness of economic inclusion programs across population groups?]{`r if (str_detect(data$learning_p,"Cost-effectiveness across population groups")) {".activelp"}`} <br>
[- What modifications in bundle design and delivery are necessary to increase cost-effectiveness for different sub-groups?]{`r if (str_detect(data$learning_p,"Increasing cost-effectiveness for sub-groups")) {".activelp"}`}
:::

::: {class='col-sm-3 learningdetails'}
[-	How to adapt economic inclusion programs in urban contexts?]{`r if (str_detect(data$learning_p,"Adapting programs to urban contexts")) {".activelp"}`} <br>
[- How to adapt economic inclusion programs in FCS and displacement affected contexts?]{`r if (str_detect(data$learning_p,"Adapting programs to fragile contexts")) {".activelp"}`}
:::

::: {class='col-sm-3 learningdetails'}
[- Do economic inclusion programs improve households' resilience to (climate, conflict, or economic) shocks? How?]{`r if (str_detect(data$learning_p,"Effects on resilience and mechanisms")) {".activelp"}`}
:::
